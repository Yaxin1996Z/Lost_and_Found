<?php       
  $con=mysqli_connect("localhost","root","zyx960915","Lost_and_Found") or die('数据库连接失败！</br>错误原因：'.mysqli_error($con));
...
if($todo=="insert"){
  ...
  echo 'insert sucess';
    ...
    $result=mysqli_query($con,$sql2) or die('用户信息插入失败！</br>错误原因：'.mysqli_error($con));
    echo 'update sucess';
  }